...
// NOTE: SVG gradient/filter IDs (e.g., "shellTop", "gooseBody") are unique per component.
// Since only one scene renders at a time and no component appears multiple times
// within a single scene, these IDs never clash in the DOM.
// If a future scene needs the same character twice, add a `prefix` prop to that component.
...
// ============ GOOSE ============
export const Goose = ({ size = 120, side = 'left', mood = 'neutral', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 200 200" className={className}
    ...
    <defs>
      ...
      <radialGradient id="gooseBelly" cx="50%" cy="40%">
    ...
    <path d="M132,98 Q150,80 158,62 Q156,82 148,95" fill="#B0B0B0" />
    <path d="M135,100 Q155,85 160,70 Q158,88 150,98" fill="#BDBDBD" />
    <path d="M138,105 Q162,92 165,78 Q162,95 152,105" fill="#D0D0D0" />
    {/* Body */}
    <ellipse cx="100" cy="115" rx="48" ry="35" fill="url(#gooseBody)" filter="url(#gooseShadow)" />
    {/* Belly highlight */}
    <ellipse cx="95" cy="120" rx="32" ry="22" fill="url(#gooseBelly)" opacity="0.6" />
    {/* Wing - detailed feathers */}
    <path d="M70,95 Q55,85 50,100 Q55,110 70,115 Q90,120 110,112" fill="#BDBDBD" />
    <path d="M75,98 Q62,92 58,103 Q62,110 75,113" fill="#D8D8D8" opacity="0.6" />
    {/* Wing feather lines */}
    <path d="M65,100 Q72,105 80,108" stroke="#A0A0A0" strokeWidth="0.8" fill="none" opacity="0.5" />
    <path d="M60,105 Q68,108 76,112" stroke="#A0A0A0" strokeWidth="0.8" fill="none" opacity="0.5" />
    {/* Neck - smooth curve */}
    <path d="M65,100 Q55,70 50,45 Q48,35 55,30" fill="url(#gooseBody)" stroke="#D8D8D8" strokeWidth="1" />
    <path d="M72,100 Q63,72 58,48 Q56,38 60,33" fill="url(#gooseBody)" />
    {/* Head */}
    <circle cx="55" cy="32" r="16" fill="url(#gooseBody)" />
    {/* Cheek blush */}
    <circle cx="52" cy="36" r="5" fill="#FFCDD2" opacity="0.3" />
    {/* Eye */}
    <ellipse cx="48" cy="28" rx="4.5" ry={mood === 'worried' ? 5.5 : mood === 'happy' ? 3.5 : 4.5} fill="white">
      <animate attributeName="ry" values={`${mood === 'happy' ? 3.5 : 4.5};0.8;${mood === 'happy' ? 3.5 : 4.5}`} dur="4s" begin="2s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </ellipse>
    <circle cx="48" cy="28" r="2.8" fill="#1A1A1A">
      <animate attributeName="r" values="2.8;0.2;2.8" dur="4s" begin="2s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    <circle cx="47" cy="27" r="1.2" fill="white">
      <animate attributeName="r" values="1.2;0.1;1.2" dur="4s" begin="2s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    {/* Eyebrow */}
    {mood === 'worried' && <path d="M44,23 Q48,21 52,23" stroke="#888" strokeWidth="1.2" fill="none" />}
    {mood === 'angry' && <path d="M44,24 Q48,22 52,25" stroke="#888" strokeWidth="1.5" fill="none" />}
    {/* Beak - more detailed */}
    <path d="M38,30 L23,33 L25,36 L38,37" fill="#FF8F00" stroke="#E65100" strokeWidth="0.8" />
    <path d="M38,33 L26,34.5" stroke="#FFB300" strokeWidth="0.5" opacity="0.5" />
    {/* Beak expression */}
    {mood === 'happy' && <path d="M30,36 Q33,38 36,36" stroke="#E65100" strokeWidth="0.6" fill="none" />}
    {mood === 'worried' && <path d="M30,37 Q33,35 36,37" stroke="#E65100" strokeWidth="0.6" fill="none" />}
    {/* Feet - webbed detail */}
    ...
    <path d="M73,157 L78,162 L85,157" stroke="#E65100" strokeWidth="0.5" fill="none" />
    <path d="M103,157 L108,162 L115,157" stroke="#E65100" strokeWidth="0.5" fill="none" />
  </svg>
);
...
export const Deer = ({ size = 100, mood = 'neutral', className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 200 200" className={className}>
    <defs>
      <radialGradient id="deerFur" cx="40%" cy="35%">
        <stop offset="0%" stopColor="#D4A85A" />
        <stop offset="60%" stopColor="#C49A5A" />
        <stop offset="100%" stopColor="#8B6B3A" />
      </radialGradient>
      <radialGradient id="deerBelly" cx="50%" cy="40%">
        <stop offset="0%" stopColor="#F0DEB8" />
        <stop offset="100%" stopColor="#D4B87A" />
      </radialGradient>
      <filter id="deerShadow"><feDropShadow dx="1" dy="2" stdDeviation="2" floodOpacity="0.18" /></filter>
    </defs>
    {/* Tail - small fluffy */}
    <ellipse cx="152" cy="110" rx="6" ry="5" fill="#F0DEB8" />
    {/* Body */}
    <ellipse cx="105" cy="125" rx="45" ry="30" fill="url(#deerFur)" filter="url(#deerShadow)" />
    {/* Belly highlight */}
    <ellipse cx="105" cy="132" rx="32" ry="20" fill="url(#deerBelly)" opacity="0.5" />
    {/* Back legs */}
    <rect x="130" y="148" width="10" height="35" rx="4" fill="#8B6B3A" />
    <rect x="140" y="148" width="10" height="33" rx="4" fill="#9B7B4A" opacity="0.5" />
    {/* Front legs */}
    <rect x="68" y="148" width="10" height="35" rx="4" fill="#8B6B3A" />
    <rect x="78" y="148" width="10" height="33" rx="4" fill="#9B7B4A" opacity="0.5" />
    {/* Hooves */}
    <rect x="66" y="180" width="14" height="7" rx="3" fill="#4E342E" />
    <rect x="128" y="180" width="14" height="7" rx="3" fill="#4E342E" />
    {/* Neck - graceful curve */}
    <path d="M70,110 Q60,85 65,60" fill="url(#deerFur)" />
    <path d="M80,108 Q72,88 75,65" fill="url(#deerFur)" />
    {/* Neck front lighter */}
    <path d="M72,105 Q65,85 68,65" fill="url(#deerBelly)" opacity="0.4" />
    {/* Head */}
    <ellipse cx="62" cy="55" rx="20" ry="18" fill="url(#deerFur)" />
    {/* Face marking */}
    <path d="M55,50 Q62,40 69,50 Q62,62 55,50" fill="url(#deerBelly)" opacity="0.4" />
    {/* Antlers - more detailed */}
    <path d="M55,42 Q48,25 40,18 M48,28 Q42,20 33,22" stroke="#8B6B3A" strokeWidth="3" fill="none" strokeLinecap="round" />
    <path d="M70,42 Q77,25 85,18 M77,28 Q83,20 90,22" stroke="#8B6B3A" strokeWidth="3" fill="none" strokeLinecap="round" />
    {/* Antler tips */}
    <circle cx="40" cy="18" r="2" fill="#A0855A" />
    <circle cx="33" cy="22" r="2" fill="#A0855A" />
    <circle cx="85" cy="18" r="2" fill="#A0855A" />
    <circle cx="90" cy="22" r="2" fill="#A0855A" />
    {/* Ears */}
    <ellipse cx="48" cy="42" rx="6" ry="10" fill="url(#deerFur)" transform="rotate(-15,48,42)" />
    <ellipse cx="76" cy="42" rx="6" ry="10" fill="url(#deerFur)" transform="rotate(15,76,42)" />
    <ellipse cx="48" cy="43" rx="3.5" ry="6" fill="#FFAB91" opacity="0.3" transform="rotate(-15,48,43)" />
    <ellipse cx="76" cy="43" rx="3.5" ry="6" fill="#FFAB91" opacity="0.3" transform="rotate(15,76,43)" />
    {/* Eyes - both sides */}
    <ellipse cx="55" cy="52" rx="4.5" ry={mood === 'scared' ? 6 : 5} fill="white">
      <animate attributeName="ry" values={`${mood === 'scared' ? 6 : 5};0.6;${mood === 'scared' ? 6 : 5}`} dur="5s" begin="1.5s" repeatCount="indefinite" keyTimes="0;0.03;0.06" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </ellipse>
    <circle cx="55" cy="52" r="2.8" fill="#2C1810">
      <animate attributeName="r" values="2.8;0.2;2.8" dur="5s" begin="1.5s" repeatCount="indefinite" keyTimes="0;0.03;0.06" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    <circle cx="54" cy="51" r="1.2" fill="white">
      <animate attributeName="r" values="1.2;0.1;1.2" dur="5s" begin="1.5s" repeatCount="indefinite" keyTimes="0;0.03;0.06" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    {/* Right eye */}
    <ellipse cx="70" cy="53" rx="3.5" ry={mood === 'scared' ? 5 : 4} fill="white">
      <animate attributeName="ry" values={`${mood === 'scared' ? 5 : 4};0.5;${mood === 'scared' ? 5 : 4}`} dur="5s" begin="1.5s" repeatCount="indefinite" keyTimes="0;0.03;0.06" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </ellipse>
    <circle cx="70" cy="53" r="2.2" fill="#2C1810">
      <animate attributeName="r" values="2.2;0.2;2.2" dur="5s" begin="1.5s" repeatCount="indefinite" keyTimes="0;0.03;0.06" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    {/* Long eyelashes */}
    <path d="M51,48 Q53,46 55,47" stroke="#5D4037" strokeWidth="0.7" fill="none" />
    <path d="M67,49 Q69,47 71,48" stroke="#5D4037" strokeWidth="0.7" fill="none" />
    {/* Nose */}
    <ellipse cx="52" cy="62" rx="4" ry="3" fill="#2C1810" />
    <ellipse cx="51" cy="61" rx="1.5" ry="1" fill="#5D4037" opacity="0.3" />
    {/* Mouth */}
    {mood === 'happy' ? (
      <path d="M48,66 Q52,70 56,66" stroke="#5D4037" strokeWidth="1.2" fill="none" />
    ) : mood === 'scared' ? (
      <ellipse cx="52" cy="67" rx="3" ry="4" fill="#3E2723" />
    ) : (
      <path d="M49,66 Q52,68 55,66" stroke="#5D4037" strokeWidth="1" fill="none" />
    )}
    {/* Body spots - white dapple pattern */}
    <circle cx="88" cy="116" r="3.5" fill="white" opacity="0.25" />
    <circle cx="100" cy="112" r="3" fill="white" opacity="0.25" />
    <circle cx="112" cy="118" r="3.5" fill="white" opacity="0.25" />
    <circle cx="95" cy="125" r="2.5" fill="white" opacity="0.2" />
    <circle cx="118" cy="125" r="3" fill="white" opacity="0.2" />
    <circle cx="105" cy="132" r="2.5" fill="white" opacity="0.2" />
    <circle cx="128" cy="116" r="2.5" fill="white" opacity="0.2" />
  </svg>
);
...
export const Fox = ({ size = 100, mood = 'neutral', className = '' }) => {
  const isClever = mood === 'clever' || mood === 'scheming';
  return (
  <svg width={size} height={size} viewBox="0 0 200 200" className={className}>
    <defs>
      ...
      <radialGradient id="foxBelly" cx="50%" cy="40%">
        <stop offset="0%" stopColor="#FFF3E0" />
        <stop offset="100%" stopColor="#FFE0B2" />
      </radialGradient>
      <filter id="foxShadow"><feDropShadow dx="1" dy="2" stdDeviation="2" floodOpacity="0.2" /></filter>
    </defs>
    ...
    <path d="M17,88 Q16,84 20,83" fill="#FFF3E0" opacity="0.5" />
    {/* Tail fur texture */}
    <path d="M25,100 Q30,95 35,105" stroke="#D46A1A" strokeWidth="0.6" fill="none" opacity="0.4" />
    <path d="M30,108 Q34,103 38,112" stroke="#D46A1A" strokeWidth="0.6" fill="none" opacity="0.4" />
    {/* Body */}
    <ellipse cx="100" cy="130" rx="38" ry="32" fill="url(#foxFur)" filter="url(#foxShadow)" />
    {/* Belly */}
    <ellipse cx="100" cy="138" rx="24" ry="20" fill="url(#foxBelly)" />
    {/* Legs */}
    <rect x="72" y="155" width="10" height="25" rx="4" fill="#D46A1A" />
    <rect x="118" y="155" width="10" height="25" rx="4" fill="#D46A1A" />
    {/* Paws - darker */}
    <ellipse cx="77" cy="182" rx="7" ry="4" fill="#A0500F" />
    <ellipse cx="123" cy="182" rx="7" ry="4" fill="#A0500F" />
    {/* Head */}
    <ellipse cx="100" cy="78" rx="28" ry="25" fill="url(#foxFur)" />
    {/* Face markings */}
    <ellipse cx="100" cy="88" rx="18" ry="14" fill="url(#foxBelly)" />
    {/* Cheek fluff */}
    <path d="M72,82 Q68,78 72,74" stroke="#FFE0B2" strokeWidth="2" fill="none" opacity="0.4" />
    <path d="M128,82 Q132,78 128,74" stroke="#FFE0B2" strokeWidth="2" fill="none" opacity="0.4" />
    ...
    {/* Inner ear pink */}
    <polygon points="78,53 71,38 82,49" fill="#FFAB91" opacity="0.3" />
    <polygon points="122,53 129,38 118,49" fill="#FFAB91" opacity="0.3" />
    {/* Eyebrows */}
    {isClever && <>
      <path d="M82,64 Q88,61 94,64" stroke="#A0500F" strokeWidth="1.5" fill="none" />
      <path d="M106,64 Q112,61 118,64" stroke="#A0500F" strokeWidth="1.5" fill="none" />
    </>}
    {mood === 'worried' && <>
      <path d="M82,64 Q88,62 94,65" stroke="#A0500F" strokeWidth="1.2" fill="none" />
      <path d="M106,65 Q112,62 118,64" stroke="#A0500F" strokeWidth="1.2" fill="none" />
    </>}
    {/* Eyes */}
    <ellipse cx="90" cy="74" rx="5" ry={isClever ? 3.5 : 5.5} fill="white">
      <animate attributeName="ry" values={`${isClever ? 3.5 : 5.5};0.8;${isClever ? 3.5 : 5.5}`} dur="4.5s" begin="1s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </ellipse>
    <ellipse cx="110" cy="74" rx="5" ry={isClever ? 3.5 : 5.5} fill="white">
      <animate attributeName="ry" values={`${isClever ? 3.5 : 5.5};0.8;${isClever ? 3.5 : 5.5}`} dur="4.5s" begin="1s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </ellipse>
    <circle cx="90" cy="74" r="3" fill="#5D4037">
      <animate attributeName="r" values="3;0.2;3" dur="4.5s" begin="1s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    <circle cx="110" cy="74" r="3" fill="#5D4037">
      <animate attributeName="r" values="3;0.2;3" dur="4.5s" begin="1s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    {/* Eye highlights */}
    <circle cx="91" cy="73" r="1.3" fill="white">
      <animate attributeName="r" values="1.3;0.1;1.3" dur="4.5s" begin="1s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    <circle cx="111" cy="73" r="1.3" fill="white">
      <animate attributeName="r" values="1.3;0.1;1.3" dur="4.5s" begin="1s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
    </circle>
    {/* Nose */}
    <ellipse cx="100" cy="84" rx="4.5" ry="3.5" fill="#2C1810" />
    <ellipse cx="99" cy="83" rx="1.5" ry="1" fill="#5D4037" opacity="0.4" />
    {/* Mouth */}
    {isClever ? (
      <path d="M92,90 Q100,96 108,90" stroke="#5D4037" strokeWidth="1.5" fill="none" />
    ) : mood === 'happy' ? (
      <path d="M92,90 Q100,98 108,90" stroke="#5D4037" strokeWidth="1.5" fill="none" />
    ) : mood === 'worried' ? (
      <path d="M94,92 Q100,88 106,92" stroke="#5D4037" strokeWidth="1.5" fill="none" />
    ) : (
      <path d="M94,88 Q100,94 106,88" stroke="#2C1810" strokeWidth="1.5" fill="none" />
    )}
    {/* Whiskers */}
    <line x1="75" y1="82" x2="60" y2="78" stroke="#D46A1A" strokeWidth="0.8" opacity="0.4" />
    <line x1="75" y1="86" x2="58" y2="86" stroke="#D46A1A" strokeWidth="0.8" opacity="0.4" />
    <line x1="125" y1="82" x2="140" y2="78" stroke="#D46A1A" strokeWidth="0.8" opacity="0.4" />
    <line x1="125" y1="86" x2="142" y2="86" stroke="#D46A1A" strokeWidth="0.8" opacity="0.4" />
  </svg>
  );
};
...
export const Villagers = ({ count = 5, className = '' }) => (
  <svg viewBox="0 0 400 130" className={className} style={{ width: '250px' }}>
    {Array.from({ length: count }).map((_, i) => {
      const x = 30 + i * 70;
      const colors = ['#E53935', '#1E88E5', '#43A047', '#FF8F00', '#8E24AA'];
      const skinTones = ['#D7A86E', '#FFCC80', '#C68642', '#FFCC80', '#D7A86E'];
      const hairColors = ['#1A1A1A', '#3E2723', '#1A1A1A', '#4E342E', '#1A1A1A'];
      const color = colors[i % colors.length];
      const skin = skinTones[i % skinTones.length];
      const hair = hairColors[i % hairColors.length];
      return (
        <g key={i}>
          {/* Body - rounded kurta/top */}
          <path d={`M${x-14},72 Q${x-16},65 ${x-10},62 L${x+10},62 Q${x+16},65 ${x+14},72 L${x+16},105 Q${x},110 ${x-16},105 Z`} fill={color} />
          {/* Neckline */}
          <path d={`M${x-5},62 Q${x},66 ${x+5},62`} fill="none" stroke={color} strokeWidth="1" opacity="0.6" />
          {/* Cloth border/pattern */}
          <path d={`M${x-15},100 L${x+15},100`} stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" />
          {/* Arms */}
          <path d={`M${x-14},68 Q${x-24},72 ${x-22},82`} stroke={skin} strokeWidth="5" fill="none" strokeLinecap="round" />
          <path d={`M${x+14},68 Q${x+24},72 ${x+22},82`} stroke={skin} strokeWidth="5" fill="none" strokeLinecap="round" />
          {/* Hands */}
          <circle cx={x-22} cy={82} r="3" fill={skin} />
          <circle cx={x+22} cy={82} r="3" fill={skin} />
          {/* Head */}
          <circle cx={x} cy={48} r="14" fill={skin} />
          {/* Hair */}
          <path d={`M${x-14},45 Q${x-12},34 ${x},32 Q${x+12},34 ${x+14},45`} fill={hair} />
          {/* Eyes with blink */}
          <ellipse cx={x-4} cy={47} rx="2" ry="2.5" fill="white" >
            <animate attributeName="ry" values="2.5;0.3;2.5" dur={`${4 + i * 0.5}s`} begin={`${i * 0.3}s`} repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </ellipse>
          <ellipse cx={x+4} cy={47} rx="2" ry="2.5" fill="white" >
            <animate attributeName="ry" values="2.5;0.3;2.5" dur={`${4 + i * 0.5}s`} begin={`${i * 0.3}s`} repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </ellipse>
          <circle cx={x-4} cy={47} r="1.5" fill="#2C1810" >
            <animate attributeName="r" values="1.5;0.1;1.5" dur={`${4 + i * 0.5}s`} begin={`${i * 0.3}s`} repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </circle>
          <circle cx={x+4} cy={47} r="1.5" fill="#2C1810" >
            <animate attributeName="r" values="1.5;0.1;1.5" dur={`${4 + i * 0.5}s`} begin={`${i * 0.3}s`} repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </circle>
          {/* Eyebrows */}
          <path d={`M${x-6},44 Q${x-4},43 ${x-2},44`} stroke={hair} strokeWidth="0.8" fill="none" />
          <path d={`M${x+2},44 Q${x+4},43 ${x+6},44`} stroke={hair} strokeWidth="0.8" fill="none" />
          {/* Nose */}
          <path d={`M${x},49 L${x-1},52 L${x+1},52`} fill={skin} stroke="rgba(0,0,0,0.1)" strokeWidth="0.5" />
          {/* Smile */}
          <path d={`M${x-3},55 Q${x},58 ${x+3},55`} fill="none" stroke="#5D4037" strokeWidth="1" />
          {/* Cheek blush */}
          <circle cx={x-7} cy={52} r="3" fill="#FFAB91" opacity="0.25" />
          <circle cx={x+7} cy={52} r="3" fill="#FFAB91" opacity="0.25" />
          {/* Legs */}
          <rect x={x-8} y={105} width="7" height="16" rx="3" fill={skin} />
          <rect x={x+1} y={105} width="7" height="16" rx="3" fill={skin} />
          {/* Feet */}
          <ellipse cx={x-5} cy={122} rx="5" ry="3" fill="#5D4037" />
          <ellipse cx={x+5} cy={122} rx="5" ry="3" fill="#5D4037" />
        </g>
      );
    })}
...
export const Stars2 = ({ count = 12 }) => (
  <svg viewBox="0 0 900 150" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '40%', pointerEvents: 'none' }}>
    {Array.from({ length: count }).map((_, i) => {
      const x = 30 + (i * 73) % 850;
      const y = 15 + (i * 41) % 120;
      const size = 1 + (i % 3);
...
export const Prahlad = ({ size = 130, mood = 'praying', className = '' }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" className={className}>
      <defs>
        <radialGradient id="prahladSkin" cx="45%" cy="35%">
          <stop offset="0%" stopColor="#D7A86E" />
          <stop offset="100%" stopColor="#8D6E63" />
        </radialGradient>
        <radialGradient id="prahladGlow" cx="50%" cy="50%">
          <stop offset="0%" stopColor="#FFF9C4" stopOpacity="0.4" />
          <stop offset="100%" stopColor="#FFF9C4" stopOpacity="0" />
        </radialGradient>
      </defs>
      {/* Divine glow when praying */}
      {mood === 'praying' && (
        <circle cx="60" cy="50" r="50" fill="url(#prahladGlow)">
      ...
      {/* Cloth pattern */}
      <path d="M44,75 L76,75" stroke="#FDD835" strokeWidth="0.8" opacity="0.5" />
      {/* Dhoti lower */}
      <rect x="44" y="80" width="32" height="15" rx="3" fill="#FFFFFF" stroke="#FDD835" strokeWidth="1" />
      {/* Dhoti fold lines */}
      <path d="M50,82 L50,94" stroke="#FDD835" strokeWidth="0.5" opacity="0.4" />
      <path d="M58,82 L58,94" stroke="#FDD835" strokeWidth="0.5" opacity="0.4" />
      <path d="M66,82 L66,94" stroke="#FDD835" strokeWidth="0.5" opacity="0.4" />
      {/* Arms */}
      {mood === 'praying' ? (
        <>
          <path d="M44,60 Q36,65 38,72" stroke="url(#prahladSkin)" strokeWidth="6" fill="none" strokeLinecap="round" />
          <path d="M76,60 Q84,65 82,72" stroke="url(#prahladSkin)" strokeWidth="6" fill="none" strokeLinecap="round" />
          {/* Hands together */}
          <ellipse cx="60" cy="62" rx="5" ry="7" fill="url(#prahladSkin)" />
          {/* Finger lines */}
          <path d="M58,58 L58,66" stroke="#C49A5A" strokeWidth="0.5" opacity="0.3" />
          <path d="M62,58 L62,66" stroke="#C49A5A" strokeWidth="0.5" opacity="0.3" />
        </>
      ) : (
        <>
          <path d="M44,60 Q34,65 32,72" stroke="url(#prahladSkin)" strokeWidth="6" fill="none" strokeLinecap="round" />
          <path d="M76,60 Q86,65 88,72" stroke="url(#prahladSkin)" strokeWidth="6" fill="none" strokeLinecap="round" />
          <circle cx="32" cy="72" r="3" fill="url(#prahladSkin)" />
          <circle cx="88" cy="72" r="3" fill="url(#prahladSkin)" />
        </>
      )}
      {/* Prayer beads */}
      <circle cx="60" cy="56" r="12" fill="none" stroke="#FF8F00" strokeWidth="1.5" strokeDasharray="2.5,2" />
      {/* Bead highlights */}
      <circle cx="48" cy="56" r="1.5" fill="#FFB300" />
      <circle cx="72" cy="56" r="1.5" fill="#FFB300" />
      <circle cx="60" cy="44" r="1.5" fill="#FFB300" />
      {/* Head */}
      <circle cx="60" cy="35" r="17" fill="url(#prahladSkin)" />
      {/* Cheeks */}
      <circle cx="48" cy="38" r="4" fill="#FFAB91" opacity="0.25" />
      <circle cx="72" cy="38" r="4" fill="#FFAB91" opacity="0.25" />
      {/* Hair */}
      <path d="M43,30 Q48,18 60,20 Q72,18 77,30" fill="#1A1A1A" />
      {/* Hair curl detail */}
      <path d="M45,28 Q47,24 50,26" stroke="#333" strokeWidth="0.5" fill="none" />
      <path d="M70,26 Q73,24 75,28" stroke="#333" strokeWidth="0.5" fill="none" />
      {/* Tilak - V-shape Vaishnava */}
      <path d="M57,22 L60,28 L63,22" fill="none" stroke="#FFD54F" strokeWidth="2" strokeLinecap="round" />
      <circle cx="60" cy="24" r="1.5" fill="#E53935" />
      {/* Eyes */}
      {mood === 'praying' ? (
        <>
          <path d="M52,35 Q55,37 58,35" fill="none" stroke="#1A1A1A" strokeWidth="1.5" />
          <path d="M62,35 Q65,37 68,35" fill="none" stroke="#1A1A1A" strokeWidth="1.5" />
          {/* Eyelashes */}
          <path d="M52,35 L51,33" stroke="#1A1A1A" strokeWidth="0.5" />
          <path d="M68,35 L69,33" stroke="#1A1A1A" strokeWidth="0.5" />
        </>
      ) : (
        <>
          <ellipse cx="54" cy="35" rx="3" ry="3.5" fill="white">
            <animate attributeName="ry" values="3.5;0.4;3.5" dur="4s" begin="1.8s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </ellipse>
          <ellipse cx="66" cy="35" rx="3" ry="3.5" fill="white">
            <animate attributeName="ry" values="3.5;0.4;3.5" dur="4s" begin="1.8s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </ellipse>
          <circle cx="54" cy="35" r="2" fill="#1A1A1A">
            <animate attributeName="r" values="2;0.2;2" dur="4s" begin="1.8s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </circle>
          <circle cx="66" cy="35" r="2" fill="#1A1A1A">
            <animate attributeName="r" values="2;0.2;2" dur="4s" begin="1.8s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </circle>
          <circle cx="55" cy="34" r="0.8" fill="white" />
          <circle cx="67" cy="34" r="0.8" fill="white" />
        </>
      )}
      {/* Eyebrows */}
      {mood === 'brave' && <>
        <path d="M50,31 Q54,30 58,32" stroke="#1A1A1A" strokeWidth="1" fill="none" />
        <path d="M62,32 Q66,30 70,31" stroke="#1A1A1A" strokeWidth="1" fill="none" />
      </>}
      {/* Nose */}
      <path d="M59,37 L58,40 L62,40" fill="none" stroke="rgba(0,0,0,0.15)" strokeWidth="0.8" />
      {/* Mouth */}
      {mood === 'happy' ? (
        <path d="M54,43 Q60,48 66,43" fill="none" stroke="#5D4037" strokeWidth="1.3" />
      ) : mood === 'brave' ? (
        <line x1="55" y1="44" x2="65" y2="44" stroke="#5D4037" strokeWidth="1.5" />
      ) : (
        <path d="M56,43 Q60,46 64,43" fill="none" stroke="#5D4037" strokeWidth="1" />
      )}
      {/* Ears */}
      <ellipse cx="43" cy="35" rx="3" ry="5" fill="url(#prahladSkin)" />
      <ellipse cx="77" cy="35" rx="3" ry="5" fill="url(#prahladSkin)" />
      {/* Legs */}
      <rect x="48" y="93" width="8" height="14" rx="4" fill="url(#prahladSkin)" />
      <rect x="64" y="93" width="8" height="14" rx="4" fill="url(#prahladSkin)" />
      {/* Feet */}
      <ellipse cx="52" cy="108" rx="6" ry="3" fill="#5D4037" />
      <ellipse cx="68" cy="108" rx="6" ry="3" fill="#5D4037" />
    </svg>
  );
};
...
export const Shinchan = ({ size = 130, mood = 'lazy', className = '' }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" className={className}>
      <defs>
        <radialGradient id="shinchanSkin" cx="45%" cy="35%">
          <stop offset="0%" stopColor="#FFE0B2" />
          <stop offset="100%" stopColor="#FFCC80" />
        </radialGradient>
      </defs>
      {/* Body - red shirt */}
      <rect x="40" y="54" width="40" height="32" rx="8" fill="#F44336" />
      {/* Shirt collar */}
      <path d="M50,54 Q60,58 70,54" fill="none" stroke="#D32F2F" strokeWidth="1.5" />
      {/* Shirt highlight */}
      <ellipse cx="55" cy="65" rx="8" ry="10" fill="#EF5350" opacity="0.3" />
      {/* Shorts */}
      <rect x="42" y="82" width="36" height="14" rx="5" fill="#FDD835" />
      {/* Shorts line */}
      <line x1="60" y1="82" x2="60" y2="96" stroke="#F9A825" strokeWidth="1" />
      {/* Arms */}
      <path d="M40,58 Q30,62 28,70" stroke="url(#shinchanSkin)" strokeWidth="7" fill="none" strokeLinecap="round" />
      <path d="M80,58 Q90,62 92,70" stroke="url(#shinchanSkin)" strokeWidth="7" fill="none" strokeLinecap="round" />
      {/* Hands */}
      <circle cx="28" cy="70" r="4" fill="url(#shinchanSkin)" />
      <circle cx="92" cy="70" r="4" fill="url(#shinchanSkin)" />
      {/* Head - round */}
      <circle cx="60" cy="34" r="24" fill="url(#shinchanSkin)" />
      {/* Ears */}
      <ellipse cx="36" cy="36" rx="4" ry="6" fill="url(#shinchanSkin)" />
      <ellipse cx="84" cy="36" rx="4" ry="6" fill="url(#shinchanSkin)" />
      <ellipse cx="36" cy="37" rx="2" ry="3" fill="#FFAB91" opacity="0.3" />
      <ellipse cx="84" cy="37" rx="2" ry="3" fill="#FFAB91" opacity="0.3" />
      {/* Hair - black bowl cut (signature) */}
      <path d="M36,26 Q42,12 60,14 Q78,12 84,26 L82,32 Q70,27 50,27 L48,32 Z" fill="#1A1A1A" />
      {/* Hair shine */}
      <path d="M50,18 Q55,16 60,18" stroke="#333" strokeWidth="1" fill="none" opacity="0.4" />
      {/* THICK eyebrows - signature Shinchan */}
      <rect x="45" y="28" width="12" height="5" rx="2.5" fill="#1A1A1A" />
      <rect x="63" y="28" width="12" height="5" rx="2.5" fill="#1A1A1A" />
      {/* Eyes */}
      {mood === 'scared' ? (
        <>
          <circle cx="52" cy="38" r="5" fill="#FFF" />
          <circle cx="52" cy="38" r="2.5" fill="#1A1A1A" />
          <circle cx="53" cy="37" r="1" fill="white" />
          <circle cx="68" cy="38" r="5" fill="#FFF" />
          <circle cx="68" cy="38" r="2.5" fill="#1A1A1A" />
          <circle cx="69" cy="37" r="1" fill="white" />
        </>
      ) : mood === 'lazy' ? (
        <>
          <path d="M47,38 L57,38" stroke="#1A1A1A" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M63,38 L73,38" stroke="#1A1A1A" strokeWidth="2.5" strokeLinecap="round" />
        </>
      ) : (
        <>
          <ellipse cx="52" cy="38" rx="3.5" ry="4" fill="white">
            <animate attributeName="ry" values="4;0.5;4" dur="4s" begin="2s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </ellipse>
          <ellipse cx="68" cy="38" rx="3.5" ry="4" fill="white">
            <animate attributeName="ry" values="4;0.5;4" dur="4s" begin="2s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </ellipse>
          <circle cx="52" cy="38" r="2.5" fill="#1A1A1A">
            <animate attributeName="r" values="2.5;0.2;2.5" dur="4s" begin="2s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </circle>
          <circle cx="68" cy="38" r="2.5" fill="#1A1A1A">
            <animate attributeName="r" values="2.5;0.2;2.5" dur="4s" begin="2s" repeatCount="indefinite" keyTimes="0;0.04;0.08" keySplines="0.42 0 0.58 1;0.42 0 0.58 1" calcMode="spline" />
          </circle>
      ...
      {/* Determined eyebrow angle */}
      {mood === 'determined' && <>
        <rect x="45" y="28" width="12" height="5" rx="2.5" fill="#1A1A1A" transform="rotate(-5,51,30)" />
        <rect x="63" y="28" width="12" height="5" rx="2.5" fill="#1A1A1A" transform="rotate(5,69,30)" />
      </>}
      {/* Cheeks */}
      <circle cx="43" cy="42" r="4" fill="#FF8A80" opacity="0.3" />
      <circle cx="77" cy="42" r="4" fill="#FF8A80" opacity="0.3" />
      {/* Nose */}
      <ellipse cx="60" cy="42" rx="2" ry="1.5" fill="#E0A060" />
      {/* Mouth */}
      {mood === 'proud' ? (
        <path d="M50,48 Q60,56 70,48" fill="none" stroke="#5D4037" strokeWidth="1.8" />
      ) : mood === 'scared' ? (
        <ellipse cx="60" cy="50" rx="5" ry="6" fill="#1A1A1A" />
      ) : mood === 'determined' ? (
        <path d="M52,49 Q60,47 68,49" stroke="#5D4037" strokeWidth="1.8" fill="none" />
      ) : (
        <path d="M53,48 Q60,52 67,48" fill="none" stroke="#5D4037" strokeWidth="1.3" />
      )}
      {/* Legs */}
      <rect x="46" y="94" width="10" height="16" rx="5" fill="url(#shinchanSkin)" />
      <rect x="64" y="94" width="10" height="16" rx="5" fill="url(#shinchanSkin)" />
      {/* Shoes */}
      <ellipse cx="51" cy="111" rx="7" ry="4" fill="#F44336" />
      <ellipse cx="69" cy="111" rx="7" ry="4" fill="#F44336" />
    </svg>
  );
};
