        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            <div className="comic-frame">
              ...
              {frame.dialogue && (
                <motion.div
                  className={`speech-bubble ${frame.dialogue.speaker === 'Finn' ? 'speaker-finn' : 'speaker-other'}`}
                ...
                >
                  <span className="speaker-name">{frame.dialogue.speaker}</span>
                  <p className="dialogue-text" aria-live="polite">&ldquo;{frame.dialogue.text}&rdquo;</p>
            ...
            >
              <p className="narrative-text" aria-live="polite">{frame.narrative}</p>
            </motion.div>
          </motion.div>
        </AnimatePresence>
      </div>
