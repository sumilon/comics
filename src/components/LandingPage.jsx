...
// Featured stories for the billboard
const FEATURED_IDS = ['krishna-butter', 'hanuman-sun', 'monkey-and-crocodile', 'odysseus-troy', 'chhota-bheem'];
                ...
                >
                  ...
                  <div className="nf-card-hover-info">
                    ...
                    <div className="nf-card-actions">
                      <button className="nf-card-play" aria-hidden="true">
...
const LandingPage = ({ stories, onSelectStory, continueReading }) => {
  ...
  const featuredStories = useMemo(() => {
    return FEATURED_IDS.map(id => stories.find(s => s.id === id)).filter(Boolean);
  }, [stories]);
